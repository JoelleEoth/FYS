...
void updateTheShrine() {
  insideShrine = rectRectCollision(playerPositionX, playerPositionY, PLAYER_SIZE, PLAYER_SIZE, shrinePlatform.platformX, shrinePlatformY, shrineWidth, shrineHeight);
  if (insideShrine) {
    lives=3;
  }
